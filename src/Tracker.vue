<template>
    <div class="flex justify-center items-center min-h-screen bg-purple-100">
        ...
        <div class="flex">
                <div class="flex-1 mr-8 max-w-lg">
                    ...
                    <select v-model="newExpense.category" class="input-field">
                        ...
                        <option value="Make Ups">Make ups</option>
          ...
          <div class="flex-1 relative"> 
            <div class="expenses-table-container border border-purple-500">
              <table class="w-full">
                <thead>
                  <tr>
                  ...
                  <tr v-for="(expense, index) in expenses" :key="index">
                    ...
                    <td class="border border-gray-300 px-4 py-2">
                      <button @click="editExpense(index)" class="btn-secondary">
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                      ...
                      <button @click="confirmDelete(expense.id)" class="btn-danger">
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
...
.input-field:hover {
box-shadow: 0 0 10px rgb(141, 65, 255);
}
.input-field:focus {
outline: none;
box-shadow: 0 0 10px rgba(186, 122, 255, 0.794);
}
.btn-primary {
